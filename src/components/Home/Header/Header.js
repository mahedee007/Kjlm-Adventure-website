            ...
            <Navbar bg="light" variant="light" expand="lg" >
                <Container className="header">
                    ...
                    width="100"
                     ...
                     />
                     <span className=" logo-title">KJML Adventures</span>
                    </Navbar.Brand>
                    <Navbar.Toggle aria-controls="basic-navbar-nav" className='bg-light' />
                    <Navbar.Collapse id="basic-navbar-nav"  >
                        <Nav className="ms-auto">
                            <NavLink className="text-decoration-none text-white ms-3 " to="/home">Home</NavLink>
                            <NavLink className="text-decoration-none text-white ms-3 " to="/destinations">Destinations</NavLink>
                            <NavLink className="text-decoration-none text-white ms-3 " to="/about">About</NavLink>
