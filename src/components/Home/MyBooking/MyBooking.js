...
const MyBooking = () => {
    ...
    useEffect(() => {
       fetch(`https://damp-dusk-34912.herokuapp.com/bookDestination/${user?.email}`)
      .then(res => res.json())
    ...
    return (
        <div className="mt-4 mb-5">
            <h4 className="text-warning fw-bold">My Booking</h4>
                    ...
                    <tbody>
                    {
                        booking.map(book=>
                            <tr key={book._id}>
                                ...
                                <td>
                                   <button onClick={()=>handleDelete(book?._id)} className="btn btn-danger"><i className="far fa-trash-alt"></i>Cancel</button>
                                </td>
                            </tr>
                        )
                    }
